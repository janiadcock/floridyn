...
class Q():
    ...
    def update(self, state_values, action, reward, future_state_values, update_type="q_learn", future_action=None, n=None):
        ...
        if self.approx_type == "table":
            ...
            state_indices = self._get_state_indices(state_values)
            #print("Q table being updated with state_values", state_values)
            ...
            self.table[state_indices][action] = Q_t + l*delta
...
def gradient(deltas, step=False):
    """
    ...
    Returns:
        ...
        step: Boolean, specifying whether the step action type is used. Defaults to False, meaning an action of 1 will be interpreted as increase, and an action of 0 will be interpreted as decrease.
    """
    # delta_V = deltas[0]
